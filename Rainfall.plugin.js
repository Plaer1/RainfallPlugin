...
class RainfallEffect {
	...
	initGradient() {
		this.gradient = this.ctx.createLinearGradient(0, 0, 0, -20);
		this.gradient.addColorStop(1, `rgba(0, 100, 255, 0.1)`);
		this.gradient.addColorStop(0.5, `rgba(0, 100, 255, 0.2)`);
		this.gradient.addColorStop(0, `rgba(0, 100, 255, 0.3)`);
	}
	...
	animate() {
		...
		for (const drop of this.drops) {
			drop.update();
			drop.draw(this.ctx, this.gradient);
